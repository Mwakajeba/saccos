...
class VacancyRequisitionApprovalSettingsController extends Controller
{
    public function index()
    {
        ...
        $settings = VacancyRequisitionApprovalSettings::where('company_id', $userCompanyId)
        ...
        return view('hr-payroll.lifecycle.vacancy-requisition-approval-settings.index', compact('settings', 'companies', 'branches', 'users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $data = array_merge($validated, [
            ...
            'branch_id' => $userBranchId, // This can now be null
        ...
        if ($settings) {
            ...
            $message = 'Vacancy Requisition approval settings updated successfully';
        } else {
            $data['created_by'] = Auth::id();
            $settings = VacancyRequisitionApprovalSettings::create($data);
            $message = 'Vacancy Requisition approval settings created successfully';
        }

        return redirect()->route('hr-payroll.vacancy-requisition-approval-settings.index')

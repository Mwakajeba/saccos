...
<body>
    ...
    @if($calculation['success'])
        @php
            ...
            // Derive human-readable labels based on interest cycle
            $cycle = strtolower($product['interest_cycle'] ?? 'monthly');
            $paymentLabels = [
                'daily' => 'Daily Payment',
            ...
            $paymentLabel = $paymentLabels[$cycle] ?? 'Installment Payment';
            $periodUnit = $periodUnits[$cycle] ?? 'periods';
        @endphp
        ...
        <div class="loan-details">
            ...
            <div class="detail-row">
                <div class="detail-label">{{ $paymentLabel }}:</div>
    ...
    <div class="footer">
        ...
        <p>For any queries, please contact your lease officer</p>
    </div>
</body>
</html>

...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <x-breadcrumbs-with-icons :links="[
            ...
            ['label' => 'Create New Rate', 'url' => '#', 'icon' => 'bx bx-plus']
        ]" />
        <h6 class="mb-0 text-uppercase">CREATE FX RATE</h6>
        <hr />
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                <div class="card-title d-flex align-items-center">
                                    ...
                                    <h5 class="mb-0 text-primary">Create New FX Rate</h5>
                                </div>
                                <p class="mb-0 text-muted">Add a new exchange rate for currency conversion</p>
                            </div>
            ...
            <div class="col-12">
                <div class="card radius-10 border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('accounting.fx-rates.store') }}" method="POST" id="fxRateForm">
                            @csrf
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="from_currency" id="from_currency" class="form-select select2-single @error('from_currency') is-invalid @enderror" required>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="to_currency" id="to_currency" class="form-select select2-single @error('to_currency') is-invalid @enderror" required>
                                        <option value="">Loading currencies...</option>
                                    </select>
                                    @error('to_currency')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="spot_rate" id="spot_rate" step="0.000001" min="0.000001" 
                                               ...
                                               value="{{ old('spot_rate') }}" placeholder="0.000000" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="month_end_rate" step="0.000001" min="0.000001" 
                                           ...
                                           value="{{ old('month_end_rate') }}" placeholder="0.000000">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="average_rate" step="0.000001" min="0.000001" 
                                           ...
                                           value="{{ old('average_rate') }}" placeholder="0.000000">
                                    <small class="text-muted d-block mt-1">
                                        <i class="bx bx-info-circle me-1"></i>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="source" class="form-select select2-single @error('source') is-invalid @enderror" required>
                                        ...
                                        <option value="import" {{ old('source') == 'import' ? 'selected' : '' }}>Bulk Import</option>
                                    </select>
                                    @error('source')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="notes" class="form-control @error('notes') is-invalid @enderror" rows="3" 
                                              placeholder="Optional notes about this rate...">{{ old('notes') }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-flex justify-content-end gap-2">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="bx bx-save me-1"></i> Save FX Rate
                                        </button>
                                    </div>
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
            ...
            $.get('{{ route("api.exchange-rates.currencies") }}')
                .done(function(response) {
                    if (response.success && response.data.currencies) {
                        ...
                        const oldFromCurrency = '{{ old("from_currency") }}';
                        const oldToCurrency = '{{ old("to_currency", $functionalCurrency) }}';
                        
                        // Populate From Currency dropdown
                        let fromCurrencyOptions = '<option value="">Select Currency</option>';
                        for (const [code, name] of Object.entries(currencies)) {
                            const selected = oldFromCurrency === code ? 'selected' : '';
                        ...
                        for (const [code, name] of Object.entries(currencies)) {
                            const selected = oldToCurrency === code ? 'selected' : '';
        ...
        // Handle currency change - auto-fetch rate

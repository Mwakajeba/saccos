...
@section('content')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <a href="{{ route('accounting.penalties.edit', Hashids::encode($penalty->id)) }}"
                        class="btn btn-primary me-2" style="background-color: #006400; border-color: #006400; color: white;">
                        Edit Penalty
                    </a>
                    <a href="{{ route('accounting.penalties.index') }}" class="btn btn-secondary" style="background-color: black; border-color: black; color: white;">
                        Back to Penalties
                    </a>
                </div>
            </div>
            ...
            <div class="card radius-10" style="background-color: #006400 !important; color: white !important;" mb-4">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div
                            class="avatar-lg bg-white text-white rounded-circle me-3 d-flex align-items-center justify-content-center" style="background-color: white !important;">
                            <i class="bx bx-error-circle font-size-32" style="color: #006400 !important;"></i>
                        </div>
                        <div class="flex-grow-1">
                            <h3 class="mb-1" style="color: white !important;">{{ $penalty->name }}</h3>
                            <p class="mb-0" style="color: white !important;">{{ $penalty->description ?: 'No description provided' }}</p>
                        </div>
                        <div class="d-flex gap-2">
                            {!! $penalty->status_badge !!}
                            {!! $penalty->penalty_type_badge !!}
                            <span class="badge" style="background-color: #23A036; color: white;">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card radius-10 mb-4">
                        <div class="card-header bg-primary text-white" style="background-color: #006400 !important;">
                            <h5 class="mb-0" style="color: white !important;"><i class="bx bx-info-circle me-2"></i>Basic Information</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <p class="form-control-plaintext">
                                        <strong class="fs-5" style="color: #fcd105 !important;">{{ $penalty->formatted_amount }}</strong>
                                    </p>
                                </div>
                                <div class="col-md-6 mb-3">
                    ...
                    <div class="card radius-10 mb-4">
                        <div class="card-header bg-success text-white" style="background-color: #23A036 !important;">
                            <h5 class="mb-0" style="color: white !important;"><i class="bx bx-cog me-2"></i>Penalty Configuration</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card radius-10 mb-4">
                        <div class="card-header bg-warning text-dark" style="background-color: #fcd105 !important;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold">
                                    <i class="bx bx-map-pin me-2"></i>Cluster
                                </label>
                    ...
                    <!-- Audit Information -->
                    <div class="card radius-10 mb-4">
                        <div class="card-header bg-secondary text-white" style="background-color: black !important;">
                            <h5 class="mb-0" style="color: white !important;"><i class="bx bx-history me-2"></i>Audit Information</h5>
                        </div>
                        <div class="card-body">
                            <div class="mb-3">
                                <label class="form-label fw-bold">
                    ...
                    <div class="card radius-10">
                        ...
                        <div class="card-body">
                            <div class="d-flex gap-2 flex-wrap">
                                <a href="{{ route('accounting.penalties.edit', $penalty) }}" class="btn btn-primary" style="background-color: #006400; border-color: #006400; color: white;">
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-outline-primary dropdown-toggle" type="button"
                                        data-bs-toggle="dropdown" style="border-color: #006400; color: #006400;">
                                ...
                                <button type="button" class="btn btn-outline-danger" onclick="deletePenalty()" style="color: black; border-color: black;">
    ...
    <script>
        ...
        function changeStatus(status) {
            ...
            Swal.fire({
                ...
                confirmButtonColor: status === 'active' ? '#23A036' : '#fcd105',

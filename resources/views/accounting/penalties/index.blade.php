                ...
                <div class="col mb-4">
                    <div class="card radius-10">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="widgets-icons text-white" style="background-color: #006400 !important;"><i class='bx bx-error-circle'></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-4">
                    <div class="card radius-10">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="widgets-icons text-white" style="background-color: #23A036 !important;"><i class='bx bx-check-circle'></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-4">
                    <div class="card radius-10">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="widgets-icons text-white" style="background-color: #fcd105 !important;"><i class='bx bx-dollar'></i></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-4">
                    <div class="card radius-10">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="widgets-icons text-white" style="background-color: black !important;"><i class='bx bx-percentage' style="color: white !important;"></i></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col mb-4">
                    <div class="card radius-10">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="widgets-icons text-white" style="background-color: #23A036 !important;"><i class='bx bx-money'></i></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-4">
                    <div class="card radius-10">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="widgets-icons text-white" style="background-color: #006400 !important;"><i class='bx bx-home'></i></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card radius-10">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <div>
                                    <a href="{{ route('accounting.penalties.create') }}" class="btn btn-primary" style="background-color: #006400; border-color: #006400; color: white;">
                                        Add Penalty
                                    </a>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="{{ route('accounting.penalties.show', Hashids::encode($penalty->id)) }}"
                                                        class="fw-bold" style="color: #006400 !important;">
                                                        {{ $penalty->name }}
                                                    </a>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <a href="{{ route('accounting.penalties.show', Hashids::encode($penalty->id)) }}"
                                                            class="btn btn-sm btn-outline-primary" style="border-color: #006400; color: #006400;" title="View">
                                                            <i class="bx bx-show"></i>
                                                        </a>
                                                        <a href="{{ route('accounting.penalties.edit', Hashids::encode($penalty->id)) }}"
                                                            class="btn btn-sm btn-outline-warning" style="border-color: #fcd105; color: #fcd105;" title="Edit">
                                                            <i class="bx bx-edit"></i>
                                                        </a>
                                                        <button type="button"
                                                            class="btn btn-sm btn-outline-danger delete-penalty-btn"
                                                            title="Delete" data-penalty-id="{{ Hashids::encode($penalty->id) }}"
                                                            data-penalty-name="{{ $penalty->name }}" style="color: black; border-color: black;">
                                                ...
                                                <td colspan="9" class="text-center py-4">
                                                    <div class="text-muted">
                                                        ...
                                                        <a href="{{ route('accounting.penalties.create') }}"
                                                            class="btn btn-primary" style="background-color: #006400; border-color: #006400; color: white;">

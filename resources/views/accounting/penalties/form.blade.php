...
@if($errors->any())
    <div class="alert alert-danger alert-dismissible fade show" role="alert" style="background-color: #fcd105; border-color: #fcd105; color: black;">
...
<form action="{{ $isEdit ? route('accounting.penalties.update', Hashids::encode($penalty->id)) : route('accounting.penalties.store') }}" method="POST">
    ...
    <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input @error('deduction_type') is-invalid @enderror" 
                                            ...
                                            value="over_due_principal_amount" style="accent-color: #006400;"
                                        ...
                                        <label class="form-check-label" for="over_due_principal_amount">
                                            <i class="bx bx-time me-2" style="color: #fcd105 !important;"></i>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input @error('deduction_type') is-invalid @enderror" 
                                            ...
                                            value="over_due_interest_amount" style="accent-color: #006400;"
                                        ...
                                        <label class="form-check-label" for="over_due_interest_amount">
                                            <i class="bx bx-percentage me-2" style="color: #23A036 !important;"></i>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input @error('deduction_type') is-invalid @enderror" 
                                            ...
                                            value="over_due_principal_and_interest" style="accent-color: #006400;"
                                        ...
                                        <label class="form-check-label" for="over_due_principal_and_interest">
                                            <i class="bx bx-calculator me-2" style="color: #006400 !important;"></i>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input @error('deduction_type') is-invalid @enderror" 
                                            ...
                                            value="total_principal_amount_released" style="accent-color: #006400;"
                                        ...
                                        <label class="form-check-label" for="total_principal_amount_released">
                                            <i class="bx bx-dollar-circle me-2" style="color: black !important;"></i>
        ...
        <div class="col-12">
            <div class="card radius-10 mb-4">
                <div class="card-header bg-info text-white" style="background-color: #fcd105 !important;">
                    <h5 class="mb-0" style="color: white !important;"><i class="bx bx-book-open me-2"></i>Chart Accounts</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
            ...
            <div class="card radius-10">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary" style="background-color: #006400; border-color: #006400; color: white;">

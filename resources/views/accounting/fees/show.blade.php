    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div>
                    <a href="{{ route('accounting.fees.edit', Hashids::encode($fee->id)) }}" class="btn btn-primary me-2" style="background-color: #006400; border-color: #006400; color: white;">
                        Edit Fee
                    </a>
                    <a href="{{ route('accounting.fees.index') }}" class="btn btn-secondary" style="background-color: black; border-color: black; color: white;">
                        Back to Fees
                    </a>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12 mb-4">
                    <div class="card radius-10 bg-primary" style="background-color: #006400 !important;">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <p class="mb-0 fw-bold h4" style="color: #fcd105 !important;">
                    ...
                    <div class="card radius-10">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    <label class="form-label fw-bold text-muted">Cluster</label>
                                    <p class="mb-0">
                    ...
                    <div class="card radius-10">
                        ...
                        <div class="card-body">
                            <div class="d-flex gap-2 flex-wrap">
                                <a href="{{ route('accounting.fees.edit', $fee) }}" class="btn btn-primary" style="background-color: #006400; border-color: #006400; color: white;">

                ...
                <div class="col mb-4">
                    <div class="card radius-10">
                        <div class="card-body d-flex align-items-center">
                            ...
                            <div class="widgets-icons text-white" style="background-color: #006400;"><i class='bx bx-check-circle'></i></div>
                        </div>
                    </div>
                </div>
                <div class="col mb-4">
                    <div class="card radius-10">
                        <div class="card-body d-flex align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <h4 class="mb-0 text-dark">{{ $stats['active'] }}</h4>
                            </div>
                           <div class="widgets-icons text-white" style="background-color: #006400;"><i class='bx bx-check-circle'></i></div>
                        </div>
                    </div>
                    ...
                    <div class="card radius-10">
                        <div class="card-body d-flex align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <h4 class="mb-0 text-dark">{{ $stats['fixed'] }}</h4>
                            </div>
                            <div class="widgets-icons text-white" style="background-color: #006400;"><i class='bx bx-check-circle'></i></div>
                        </div>
                    </div>
                    ...
                    <div class="card radius-10">
                        <div class="card-body d-flex align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <h4 class="mb-0 text-dark">{{ $stats['percentage'] }}</h4>
                            </div>
                            <div class="widgets-icons text-white" style="background-color: #006400;"><i class='bx bx-check-circle'></i></div>   
                        </div>
                    </div>
                    ...
                    <div class="card radius-10">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <div>
                                    <a href="{{ route('accounting.fees.create') }}" class="btn btn-primary" style="background-color: #006400; border-color: #006400; color: white;">
                                        <i class="bx bx-plus me-1"></i> Add Fee
                                    </a>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        <a href="{{ route('accounting.fees.show', Hashids::encode($fee->id)) }}"
                                                            class="btn btn-sm btn-outline-primary" style="border-color: #006400; color: #006400;">
                                                            <i class="bx bx-show"></i>
                                                        </a>
                                                        <a href="{{ route('accounting.fees.edit', Hashids::encode($fee->id)) }}"
                                                            class="btn btn-sm btn-outline-warning" style="border-color: #fcd105; color: #fcd105;">

...
@section('title', 'Share Opening Balance Import')
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="mb-0 text-uppercase text-dark">Share Opening Balance Import</h6>
        </div>
        <hr />
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('shares.opening-balance.import') }}" method="POST" enctype="multipart/form-data" id="importForm">
                            @csrf

                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="share_product_id" class="form-label">Share Product <span class="text-danger">*</span></label>
                                    <select name="share_product_id" id="share_product_id" 
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="alert alert-info">
                                        ...
                                        <ul class="mb-0">
                                            <li>Select the share product</li>
                                            <li>Select the bank account for double entry</li>
                                            <li>Select the opening balance date</li>
                                            <li>Click "Download Template" to get the Excel template with all share accounts</li>
                                        ...
                                        <strong>Note:</strong> This will create journals, journal items, GL transactions, share deposits, and log the opening balance.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="{{ route('shares.management') }}" class="btn btn-secondary">
...
<script>
    $(document).ready(function() {
        ...
        $('#downloadTemplateBtn').on('click', function(e) {
            ...
            const productId = $('#share_product_id').val();
            ...
            const url = '{{ route("shares.opening-balance.download-template") }}?' +
                       'share_product_id=' + encodeURIComponent(productId) +
            ...
            $.ajax({
                ...
                success: function(response) {
                    Swal.fire({
                        icon: 'success',
                        title: 'Success',
                        text: 'Opening balance import has been queued and processing has started.',

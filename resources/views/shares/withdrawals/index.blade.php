...
<div class="page-wrapper">
    <div class="page-content">
        <x-breadcrumbs-with-icons :links="[
            ...
            ['label' => 'Share Withdrawals', 'url' => '#', 'icon' => 'bx bx-right-arrow-alt']
             ]" />
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Share Withdrawals</h5>
                        <p class="card-text">Share Withdrawals module coming soon.</p>
                    </div>
                </div>
            </div>
        </div>

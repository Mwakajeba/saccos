...
@section('title', 'Create Share Transfer')
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="mb-0 text-uppercase text-primary">Add Share Transfer</h6>
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('shares.transfers.store') }}" method="POST" id="shareTransferForm">
                            @csrf
                                    ...
                                    <select name="journal_reference_id" id="journal_reference_id"
                                        ...
                                        @foreach($journalReferences as $journalRef)
                                            <option value="{{ $journalRef->id }}" 
                                                {{ old('journal_reference_id') == $journalRef->id ? 'selected' : '' }}>
                                ...
                                <div class="col-12">
                                    <div class="d-flex justify-content-end">
                                        <button type="submit" class="btn btn-primary">
                                            <i class="bx bx-save me-1"></i> Save Transfer
                                        </button>
                                    </div>
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        // Trigger change if accounts are already selected (for form errors)
        if ($('#from_account_id').val()) {

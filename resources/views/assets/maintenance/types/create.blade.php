...
@section('title', 'Create Maintenance Type')
    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="mb-0"><i class="bx bx-plus me-2"></i>Create Maintenance Type</h6>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('assets.maintenance.types.store') }}">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="type" class="form-select" required>
                                ...
                                <option value="major_overhaul" {{ old('type') == 'major_overhaul' ? 'selected' : '' }}>Major Overhaul</option>
                            </select>

...
@section('title', 'Create Contribution Deposit')
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h6 class="mb-0 text-uppercase text-info">Add Contribution Deposit</h6>
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('contributions.deposits.store') }}" method="POST" id="depositForm" data-has-custom-handler="true" enctype="multipart/form-data">
                            @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-info mb-0">
                            <small>
                                ...
                                <strong>Note:</strong> This will create a payment record, update GL transactions, and increase the contribution account balance.
                            </small>
                        </div>
                    </div>
                </div>

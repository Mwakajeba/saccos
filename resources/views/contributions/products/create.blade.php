                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch mt-4">
                                            <input class="form-check-input" type="checkbox" name="has_interest_on_saving"
                                                id="has_interest_on_saving" {{ old('has_interest_on_saving', true) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="category" class="form-select @error('category') is-invalid @enderror"
                                            ...
                                            <option value="Voluntary" {{ old('category') == 'Voluntary' ? 'selected' : '' }}>
                                                Voluntary</option>
                                            <option value="Mandatory" {{ old('category') == 'Mandatory' ? 'selected' : '' }}>
                                                Mandatory</option>
                                        </select>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="auto_create"
                                            ...
                                            <option value="Yes" {{ old('auto_create') == 'Yes' ? 'selected' : '' }}>Yes
                                            </option>
                                ...
                                <div class="row">
                                    ...
                                    {{-- <div class="col-md-4 mb-3">
                                        ...
                                        <select name="interest_calculation_type"
                                            ...
                                            required>
                                            <option value="">Select</option>
                                            <option value="Daily" {{ old('interest_calculation_type')=='Daily' ? 'selected'
                                                : '' }}>Daily</option>
                                            <option value="Monthly" {{ old('interest_calculation_type')=='Monthly'
                                                ? 'selected' : '' }}>Monthly</option>
                                            <option value="Annually" {{ old('interest_calculation_type')=='Annually'
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="can_withdraw"
                                                id="can_withdraw" {{ old('can_withdraw') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="has_charge"
                                                id="has_charge" {{ old('has_charge') ? 'checked' : '' }}
                                    ...
                                    <div id="chargeFields" style="display: none;">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <select name="charge_type"
                                                ...
                                                <option value="">Select</option>
                                                <option value="Fixed" {{ old('charge_type') == 'Fixed' ? 'selected' : '' }}>
                                                    Fixed</option>

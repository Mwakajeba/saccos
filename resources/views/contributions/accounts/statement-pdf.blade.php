...
<head>
    <meta charset="utf-8">
    <title>Contribution Account Statement</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <h2>Contribution Account Statement</h2>
    ...
    <div class="info-section">
        ...
        <div class="info-row">
            ...
            <div class="info-value">{{ $product->product_name ?? 'N/A' }}</div>
        </div>
        <div class="info-row">
            <div class="info-label">Opening Date:</div>
            <div class="info-value">{{ $account->opening_date->format('d M, Y') }}</div>
        </div>
        @if($branch)
        <div class="info-row">
    ...
    <div class="footer">
        ...
        <p>{{ $company->name ?? 'SmartFinance' }} - Contribution Account Statement</p>
    </div>
</body>
</html>

    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    <h5 class="mb-0"><i class="bx bx-calculator me-2"></i>Edit Salary Component</h5>
                    <p class="mb-0 text-muted">Update component details</p>
                </div>
            </div>
            <hr />
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('hr.salary-components.update', $salaryComponent->id) }}" method="POST">
                                @csrf
                                @method('PUT')

                                <div class="alert alert-info">
                                    <i class="bx bx-info-circle me-2"></i>
                                    <strong>Code:</strong> {{ $salaryComponent->component_code }} (cannot be changed)
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">Component Code</label>
                                    <input type="text" class="form-control" 
                                        value="{{ $salaryComponent->component_code }}" disabled>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('component_name') is-invalid @enderror" 
                                        ...
                                        value="{{ old('component_name', $salaryComponent->component_name) }}" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('component_type') is-invalid @enderror" 
                                        ...
                                        <option value="earning" {{ old('component_type', $salaryComponent->component_type) == 'earning' ? 'selected' : '' }}>Earning</option>
                                        <option value="deduction" {{ old('component_type', $salaryComponent->component_type) == 'deduction' ? 'selected' : '' }}>Deduction</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('calculation_type') is-invalid @enderror" 
                                        ...
                                        <option value="fixed" {{ old('calculation_type', $salaryComponent->calculation_type) == 'fixed' ? 'selected' : '' }}>Fixed Amount</option>
                                        <option value="percentage" {{ old('calculation_type', $salaryComponent->calculation_type) == 'percentage' ? 'selected' : '' }}>Percentage of Base</option>
                                        <option value="formula" {{ old('calculation_type', $salaryComponent->calculation_type) == 'formula' ? 'selected' : '' }}>Formula-Based</option>
                                    </select>
                                ...
                                <div class="mb-3" id="formula_field" style="display: none;">
                                    ...
                                    <input type="text" class="form-control @error('calculation_formula') is-invalid @enderror" 
                                        ...
                                        value="{{ old('calculation_formula', $salaryComponent->calculation_formula) }}"
                                        placeholder="e.g., {base} * 0.15 + {amount}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="0.01" min="0" 
                                                ...
                                                value="{{ old('floor_amount', $salaryComponent->floor_amount) }}">
                                            @error('floor_amount')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" step="0.01" min="0" 
                                                ...
                                                value="{{ old('ceiling_amount', $salaryComponent->ceiling_amount) }}">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" name="is_pensionable" 
                                                    ...
                                                    {{ old('is_pensionable', $salaryComponent->is_pensionable) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="is_pensionable">Pensionable</label>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" name="is_nhif_applicable" 
                                                    ...
                                                    {{ old('is_nhif_applicable', $salaryComponent->is_nhif_applicable) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="is_nhif_applicable">NHIF Applicable</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" min="0" 
                                                ...
                                                value="{{ old('display_order', $salaryComponent->display_order) }}">
                                            @error('display_order')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="bx bx-save me-1"></i>Update Component
                                    </button>
                                </div>
                            </form>
                        </div>

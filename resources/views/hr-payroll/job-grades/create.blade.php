...
@section('title', 'Create Job Grade')
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <h6 class="mb-0 text-uppercase">Create Job Grade</h6>
        <hr />
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('hr.job-grades.store') }}">
                    @csrf
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="grade_code" class="form-control @error('grade_code') is-invalid @enderror" 
                                   value="{{ old('grade_code') }}" required placeholder="e.g., G01, G02" />
                            @error('grade_code')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">Unique code for this grade</div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="grade_name" class="form-control @error('grade_name') is-invalid @enderror" 
                                   value="{{ old('grade_name') }}" required placeholder="e.g., Grade 1, Senior Level" />
                            @error('grade_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="minimum_salary" step="0.01" min="0" 
                                   ...
                                   value="{{ old('minimum_salary') }}" placeholder="0.00" />
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="midpoint_salary" step="0.01" min="0" 
                                   ...
                                   value="{{ old('midpoint_salary') }}" placeholder="0.00" />
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="maximum_salary" step="0.01" min="0" 
                                   ...
                                   value="{{ old('maximum_salary') }}" placeholder="0.00" />
                            @error('maximum_salary')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">Must be greater than or equal to minimum salary</div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-text">Inactive grades cannot be assigned to new positions</div>
                        </div>
                    </div>

                    <div class="d-flex gap-2 mt-4">
                        <button type="submit" class="btn btn-primary">
                            <i class="bx bx-save me-1"></i>Save Job Grade
                        </button>

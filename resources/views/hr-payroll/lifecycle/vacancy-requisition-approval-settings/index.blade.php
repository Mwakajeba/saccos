...
@section('title', 'Vacancy Requisition Approval Settings')
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h5 class="mb-0 text-primary">Vacancy Requisition Approval Settings</h5>
                <small class="text-muted">Configure multi-level approval workflow for vacancy requisitions</small>
            </div>
            <div>
                <a href="{{ route('hr.vacancy-requisitions.index') }}" class="btn btn-secondary">
                    <i class="bx bx-arrow-back me-1"></i> Back to Vacancy Requisitions
                </a>
            </div>
        </div>
        ...
        <div class="alert alert-info border-0">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h6 class="mb-1">Vacancy Requisition Approval Workflow</h6>
                    <p class="mb-0">Set up multi-level approval system for vacancy requisitions. Requisitions will start as <strong>Draft</strong>, move to <strong>Pending Approval</strong> when submitted, then <strong>Approved</strong> after all required approvals, or <strong>Rejected</strong> if rejected by any approver.</p>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('hr-payroll.vacancy-requisition-approval-settings.store') }}" method="POST">
                    @csrf
                            ...
                            <div class="card border">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <div class="form-check form-switch">
                                            ...
                                            <label class="form-check-label" for="approval_required">
                                                <strong>Enable Vacancy Requisition Approval</strong>
                                            </label>
                                        </div>
                                        <small class="text-muted">Require approval before vacancy requisitions are approved</small>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">How many approval levels required before approval</small>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="notes" name="notes" rows="3" 
                                                  placeholder="Additional notes about the vacancy requisition approval workflow">{{ old('notes', $settings?->notes) }}</textarea>
                                    </div>
                                        ...
                                        <div class="approval-level-config mb-4 p-3 border rounded" id="level_{{ $level }}_config" 
                                            ...
                                            <div class="row">
                                                <div class="col-md-5 mb-3">
                                                    ...
                                                    <small class="text-muted">Requisitions with budget above this amount need this level approval</small>
                                                </div>
...
const presets = {
    ...
    standard: {
        levels: 2,
        level1: { threshold: 100000, approvers: [] },
        level2: { threshold: 500000, approvers: [] }
    },
    corporate: {
        levels: 3,
        level1: { threshold: 50000, approvers: [] },
        level2: { threshold: 200000, approvers: [] },
        level3: { threshold: 1000000, approvers: [] }
    }
};
...
function applyPreset(presetName) {
    ...
    for (let i = 1; i <= preset.levels; i++) {
        ...
        if (preset[levelKey]) {
            const thresholdInput = document.getElementById(`level${i}_amount_threshold`);

...
@section('title', 'Payroll by Department Report')
...
<div class="page-wrapper">
    <div class="page-content">
        <x-breadcrumbs-with-icons :links="[
                ...
                ['label' => 'Payroll by Department', 'url' => '#', 'icon' => 'bx bx-buildings']
            ]" />
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h4 class="card-title mb-0">
                                <i class="bx bx-buildings me-2"></i>Payroll by Department Report
                            </h4>
                        </div>

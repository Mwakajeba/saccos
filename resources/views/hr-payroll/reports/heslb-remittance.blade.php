...
@section('title', 'HESLB Remittance Report')
...
<div class="page-wrapper">
    <div class="page-content">
        <x-breadcrumbs-with-icons :links="[
                ...
                ['label' => 'HESLB Remittance', 'url' => '#', 'icon' => 'bx bx-receipt']
            ]" />
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h4 class="card-title mb-0">
                                <i class="bx bx-receipt me-2"></i>HESLB DEDUCTION SCHEDULE
                            </h4>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="card border border-success">
                                    <div class="card-body text-center">
                                        <h5 class="card-title text-success">Total Deduction</h5>
                                        <h3 class="mb-0">{{ number_format($totalDeduction, 2) }} TZS</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @forelse($reportData as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data['heslb_number'] }}</td>
                                            <td class="text-end">{{ number_format($data['gross_salary'], 2) }}</td>
                                            <td class="text-center">{{ number_format($data['deduction_rate'], 1) }}%</td>
                                            <td class="text-end">{{ number_format($data['amount'], 2) }}</td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="7" class="text-center text-muted">No HESLB data available for the selected period</td>
                                        </tr>
                                    @endforelse
                                </tbody>

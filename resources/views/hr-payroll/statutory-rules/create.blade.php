...
@section('title', 'Create Statutory Rule')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    <h5 class="mb-0"><i class="bx bx-shield me-2"></i>Create Statutory Rule</h5>
                    <p class="mb-0 text-muted">Configure Tanzania statutory compliance rules</p>
                </div>
            </div>
            <hr />
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('hr.statutory-rules.store') }}" method="POST" id="statutoryRuleForm">
                                @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('rule_type') is-invalid @enderror" 
                                                ...
                                                <option value="paye" {{ old('rule_type') == 'paye' ? 'selected' : '' }}>PAYE (Income Tax)</option>
                                                <option value="nhif" {{ old('rule_type') == 'nhif' ? 'selected' : '' }}>NHIF (Health Insurance)</option>
                                                <option value="pension" {{ old('rule_type') == 'pension' ? 'selected' : '' }}>Pension (NSSF/PSSSF)</option>
                                                <option value="wcf" {{ old('rule_type') == 'wcf' ? 'selected' : '' }}>WCF (Workers Compensation)</option>
                                                <option value="sdl" {{ old('rule_type') == 'sdl' ? 'selected' : '' }}>SDL (Skills Development Levy)</option>
                                                <option value="heslb" {{ old('rule_type') == 'heslb' ? 'selected' : '' }}>HESLB (Student Loans)</option>
                                            </select>
                                            @error('rule_type')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('rule_name') is-invalid @enderror" 
                                                ...
                                                value="{{ old('rule_name') }}" 
                                                placeholder="e.g., PAYE 2024, NHIF Standard" required>
                                            @error('rule_name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            @error('effective_to')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            <small class="text-muted">Leave empty for ongoing rules</small>
                                        </div>
                                    </div>
                                </div>

                                <!-- PAYE Section -->
                                <div class="rule-type-section" id="paye_section">
                                    <hr>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01" min="0" 
                                            ...
                                            value="{{ old('paye_tax_relief') }}" 
                                            placeholder="0.00">
                                        <small class="text-muted">Monthly tax relief amount</small>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="alert alert-info mb-3">
                                            <i class="bx bx-info-circle me-2"></i>
                                            <strong>Format:</strong> Enter brackets in ascending order. Each bracket shows the income range (Over → Not Over) based on thresholds. The "Not Over" value is automatically calculated from the next bracket's threshold.
                                            <br><small>Example: If Bracket 3 has threshold 520,000 and Bracket 4 has threshold 760,000, then Bracket 3 covers: Over 520,000 → Not over 760,000</small>
                                        </div>
                                ...
                                <!-- NHIF Section -->
                                <div class="rule-type-section" id="nhif_section">
                                    <hr>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="0.01" min="0" max="100" 
                                                    ...
                                                    value="{{ old('nhif_employee_percent') }}" 
                                                    placeholder="e.g., 3.0">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="0.01" min="0" max="100" 
                                                    ...
                                                    value="{{ old('nhif_employer_percent') }}" 
                                                    placeholder="e.g., 3.0">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                ...
                                <!-- Pension Section -->
                                <div class="rule-type-section" id="pension_section">
                                    <hr>
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" name="pension_scheme_type">
                                                    ...
                                                    <option value="nssf" {{ old('pension_scheme_type') == 'nssf' ? 'selected' : '' }}>NSSF</option>
                                                    <option value="psssf" {{ old('pension_scheme_type') == 'psssf' ? 'selected' : '' }}>PSSSF</option>
                                                    <option value="other" {{ old('pension_scheme_type') == 'other' ? 'selected' : '' }}>Other</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="0.01" min="0" max="100" 
                                                    ...
                                                    value="{{ old('pension_employee_percent') }}" 
                                                    placeholder="e.g., 5.0">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="0.01" min="0" max="100" 
                                                    ...
                                                    value="{{ old('pension_employer_percent') }}" 
                                ...
                                <!-- WCF Section -->
                                <div class="rule-type-section" id="wcf_section">
                                    <hr>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="0.01" min="0" max="100" 
                                                    ...
                                                    value="{{ old('wcf_employer_percent') }}" 
                                                    placeholder="e.g., 1.0">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <!-- SDL Section -->
                                <div class="rule-type-section" id="sdl_section">
                                    <hr>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="0.01" min="0" max="100" 
                                                    ...
                                                    value="{{ old('sdl_employer_percent', 3.5) }}" 
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="1" min="1" 
                                                    ...
                                                    value="{{ old('sdl_min_employees', 10) }}" 
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="0.01" min="0" 
                                                    class="form-control" 
                                                    name="sdl_threshold" 
                                                    value="{{ old('sdl_threshold') }}" 
                                                    placeholder="Minimum payroll amount">
                                ...
                                <!-- HESLB Section -->
                                <div class="rule-type-section" id="heslb_section">
                                    <hr>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="0.01" min="0" 
                                                    class="form-control" 
                                                    name="heslb_ceiling" 
                                                    value="{{ old('heslb_ceiling') }}" 
                                                    placeholder="Maximum deduction amount">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="alert alert-info mb-3">
                                    <i class="bx bx-info-circle me-2"></i>
                                    <strong>About Categories:</strong> By default, statutory rules apply to all employees. You can restrict a rule to specific employee categories (Employment Type, Department, Position, or Grade) for multi-rate support. For example, you might have different NHIF rates for permanent vs contract employees.
                                </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="apply_to_all_employees" 
                                            ...
                                            {{ old('apply_to_all_employees', true) ? 'checked' : '' }}>
                                ...
                                <div id="category_selection_section" style="display: none;">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select select2-multiple" 
                                            ...
                                            @php
                                                $selectedEmployeeIds = old('employee_ids', []);
                                            @endphp
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted d-block mt-2">
                                            <strong>Note:</strong> An employee must match at least one category for the rule to apply. Categories are evaluated with OR logic (not AND).
                                        </small>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">Inactive rules will not be used in payroll calculations</small>
                                </div>
                                ...
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="bx bx-save me-1"></i>Create Rule
                                    </button>
                                </div>
                            </form>
                        </div>
...
$(document).ready(function() {
    ...
    $('#rule_type').on('change', function() {
        $('.rule-type-section').removeClass('active');
        const ruleType = $(this).val();
        if (ruleType) {
            $('#' + ruleType + '_section').addClass('active');
        }
    });
    ...
    function updateBracketRanges() {
        ...
        brackets.forEach(function(bracket, index) {
            ...
            $bracket.find('.range-over').text(thresholdFormatted);
            $bracket.find('.range-not-over').text(notOver);
    ...
    // Initialize category section visibility
    if (!$('#apply_to_all_employees').is(':checked')) {
        $('#category_selection_section').show();
    }
    ...
    // Form submission - clean up incomplete categories (categories are optional)

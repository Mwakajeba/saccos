...
@section('title', 'Payroll Approval Settings')
...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h5 class="mb-0 text-primary">Payroll Approval Settings</h5>
                <small class="text-muted">Configure multi-level approval workflow for payroll processing</small>
            </div>
            <div>
        ...
        <div class="alert alert-info border-0">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h6 class="mb-1">Payroll Approval Workflow</h6>
                    <p class="mb-0">Set up multi-level approval system for payroll processing. Payroll will start as <strong>Draft</strong>, move to <strong>Processing</strong> when approved, then <strong>Paid</strong> when disbursed, or <strong>Cancelled</strong> if rejected.</p>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('hr-payroll.approval-settings.store') }}" method="POST">
                    @csrf
                            ...
                            <div class="card border">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <div class="form-check form-switch">
                                            ...
                                            <label class="form-check-label" for="approval_required">
                                                <strong>Enable Payroll Approval</strong>
                                            </label>
                                        </div>
                                        <small class="text-muted">Require approval before payroll processing</small>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="text-muted">How many approval levels before payment</small>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="notes" name="notes" rows="3" 
                                                  placeholder="Additional notes about the payroll approval workflow">{{ old('notes', $settings?->notes) }}</textarea>
                                    </div>
                                        ...
                                        <div class="approval-level-config mb-4 p-3 border rounded" id="level_{{ $level }}_config" 
                                            ...
                                            <div class="row">
                                                <div class="col-md-5 mb-3">
                                                    ...
                                                    <small class="text-muted">Payrolls above this amount need this level approval</small>
                                                </div>

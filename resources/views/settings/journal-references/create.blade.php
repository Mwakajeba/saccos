...
@section('title', 'Create Journal Reference')
...
<div class="page-wrapper">
    <div class="page-content"> 
        <x-breadcrumbs-with-icons :links="[
            ...
            ['label' => 'Create Journal Reference', 'url' => '#', 'icon' => 'bx bx-plus']
        ]" />
        <h6 class="mb-0 text-uppercase">CREATE JOURNAL REFERENCE</h6>
        <hr/>
        <div class="card">
            <div class="card-body">
                <form action="{{ route('settings.journal-references.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bx bx-save me-1"></i> Save Journal Reference
                        </button>
                    </div>
                </form>
            </div>

...
@section('title', 'Receipt Voucher Approval Settings')
...
<div class="page-wrapper">
    <div class="page-content">
        <x-breadcrumbs-with-icons :links="[
            ...
            ['label' => 'Receipt Voucher Approval', 'url' => '#', 'icon' => 'bx bx-check-shield']
        ]" />
        <h6 class="mb-0 text-uppercase">RECEIPT VOUCHER APPROVAL SETTINGS</h6>
        <hr />
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-4">Receipt Voucher Approval - Simple Configuration</h4>
                        <p class="text-muted mb-4">Configure approval workflows for receipt vouchers. Set up approval levels, approvers, and approval thresholds.</p>
                        ...
                        <form action="{{ route('settings.receipt-voucher-approval.update') }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-check form-switch">
                                        ...
                                        <small class="form-text text-muted d-block">If checked, all receipt vouchers require approval regardless of amount</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row" id="direct_post_note" style="display:none;">
                                <div class="col-12">
                                    <div class="alert alert-info">
                                        ...
                                        All receipt vouchers will be saved directly to GL transactions. No approvals will be required.
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-header bg-success text-white">
                                            <h6 class="mb-0"><i class="bx bx-check-circle me-2"></i>Level 1 Approvers</h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-header bg-success text-white">
                                            <h6 class="mb-0"><i class="bx bx-check-circle me-2"></i>Level 2 Approvers</h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-header bg-success text-white">
                                            <h6 class="mb-0"><i class="bx bx-check-circle me-2"></i>Level 3 Approvers</h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-header bg-success text-white">
                                            <h6 class="mb-0"><i class="bx bx-check-circle me-2"></i>Level 4 Approvers</h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-header bg-success text-white">
                                            <h6 class="mb-0"><i class="bx bx-check-circle me-2"></i>Level 5 Approvers</h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <button type="submit" class="btn btn-success">
                                        <i class="bx bx-save me-1"></i> Update Receipt Voucher Approval Settings
                                    </button>
                        ...
                        <div class="alert alert-warning" role="alert">
                            ...
                            You don't have permission to manage receipt voucher approval settings.
                        </div>
                        @endcan
                    </div>
                </div>
